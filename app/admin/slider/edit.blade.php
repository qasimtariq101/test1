    ...
    <div class="card mb-4 "> 
      ...
      <div class="card-body d-sm-flex justify-content-between">
        <h4 class="mb-2 mb-sm-0 pt-1"> 
          ...
          <a href="{{url('admin/slider')}}">{{$page_title}}</a> <span>/</span> 
          <span>{{ __('Edit')}}</span> 
        </h4>
      </div>
    </div>
          ...
          <div class="card-body">
            <form class="eco_form" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group col-md-6">
                <label>{{ __('Name')}}</label>
                <input type="text" class="form-control" name="name" placeholder="{{ __('Category Name')}}" value="{{old('name',$slide->name)}}">
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <br/><a href="{{ url($slide->image) }}" target="_blank"><img src="{{url($slide->image)}}" class="img-fluid" style="width: 400px;"></a><br/>
                    <br/>                    
                    <div class="input-group">
                      <div class="input-group-prepend"> <span class="input-group-text" id="inputGroupFileAddon02">{{ __('Change Image')}}</span> </div>
              ...
              <div class="form-group col-md-6">
                ...
                @php
                $selected = old('active',$slide->active);
                @endphp
