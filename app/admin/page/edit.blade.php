          ...
          <div class="card-body">
            <form class="eco_form" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" placeholder="{{ __('Page Title')}}" value="{{old('title',$page->title)}}">
              </div>
              <div class="form-group">
                <label>{{ __('Content')}}</label>
                <textarea class="textarea form-control" id="editor" name="content" placeholder="{{ __('Page content')}}" rows="20">@php echo old('content',html_entity_decode($page->content)) @endphp</textarea>
              </div>
              <div class="form-group">
