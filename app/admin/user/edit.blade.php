  ...
  <div class="container mt-5"> 
    ...
    <div class="card mb-4"> 
      ...
      <div class="card-body d-sm-flex justify-content-between">
        <h4 class="mb-2 mb-sm-0 pt-1"> <a href="{{url('admin/dashboard')}}">{{ __('Admin')}}</a> <span>/</span> <a href="{{url('admin/users')}}">{{$page_title}}</a> <span>/</span> <span>{{ __('Edit')}}</span> </h4>
      </div>
    </div>
    <!-- Heading --> 
          ...
          <div class="card-body">
            <form class="eco_form" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                @php $selected = old('status',$user->status); @endphp
              ...
              <div class="form-group">
                ...
                <a href="{{url('admin/users')}}" class="btn btn-default">{{ __('Cancel')}}</a> </div>
            </form>
          </div>
        </div>
        <!--/.Card--> 
