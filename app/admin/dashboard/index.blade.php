...
<script type="text/javascript">
        //Syntax pie
        var ctxP = document.getElementById("categoryPie").getContext('2d');
        var categories_inactive = '{{$categories_inactive}}';
        var categories_active = '{{$categories_active}}';
        var myPieChart = new Chart(ctxP, {
            type: 'pie',
            data: {
                labels: ["Inactive", "Active"],
                datasets: [{
                    data: [categories_inactive, categories_active],
        ...
        //Syntax pie
        var ctxP = document.getElementById("bookChart").getContext('2d');
        var books_public = '{{$books_public}}';
        var books_unlisted = '{{$books_unlisted}}';
        var books_private = '{{$books_private}}';
        var myPieChart = new Chart(ctxP, {
            type: 'pie',
            data: {
                labels: ["Private", "Public", "Unlisted"],
                datasets: [{
                    data: [books_private, books_public, books_unlisted],
...
<main class="pt-5 mx-lg-5">
  <div class="container mt-5"> 
      ...
      <div class="row"> 
        ...
        <div class="col-xl-3 col-md-6 mb-4"> 
          ...
          <div class="card classic-admin-card primary-color">
            <div class="card-body">
              ...
              <p class="white-text">{{ __('Categories')}}</p>
              <h3>{{\App\Models\Category::count()}}</h3>
            </div>
            <div class="card-body"> <a href="{{url('admin/categories')}}" class="text-white">{{ __('View more')}}</a> </div>
          </div>
          <!--/.Card Success--> 
        ...
        <div class="col-xl-3 col-md-6 mb-4"> 
          ...
          <div class="card classic-admin-card warning-color">
            <div class="card-body">
              <div class="pull-right"> <i class="fa fa-book fa-4x"></i> </div>
              <p class="white-text">{{ __('eBooks')}}</p>
              <h3>{{\App\Models\Book::count()}}</h3>
            </div>
            <div class="card-body"> <a href="{{url('admin/books')}}" class="text-white">{{ __('View more')}}</a> </div>
          </div>
          <!--/.Card Default--> 
        ...
        <div class="col-xl-3 col-md-6 mb-4"> 
          ...
          <div class="card classic-admin-card light-blue lighten-1">
            <div class="card-body">
              ...
              <p class="white-text">{{ __('Users')}}</p>
              <h3>{{\App\User::count()}}</h3>
            </div>
            <div class="card-body"> <a href="{{url('admin/users')}}" class="text-white">{{ __('View more')}}</a> </div>
          </div>
          <!--/.Card Blue--> 
        ...
        <div class="col-xl-3 col-md-6 mb-4"> 
          ...
          <div class="card classic-admin-card red accent-2">
            <div class="card-body">
              ...
              <p class="white-text">{{ __('Reported eBooks')}}</p>
              <h3>
              {{\App\Models\Report::count()}}
              </h3d>
            </div>
            <div class="card-body"> <a href="{{url('admin/reported-books')}}" class="text-white">{{ __('View more')}}</a> </div>
          </div>
          <!--/.Card Purple--> 
    ...
    <div class="row"> 
      ...
      <div class="col-md-3 mb-4"> 
        ...
        <div class="card mb-4"> 
          ...
          <!-- Card header -->
          <div class="card-header text-center"> {{ __('Categories')}} </div>
      ...
      <div class="col-md-3 mb-4"> 
        ...
        <div class="card mb-4"> 
          ...
          <!-- Card header -->
          <div class="card-header text-center"> {{ __('eBooks')}} </div>
      ...
      <div class="col-md-3 mb-4"> 
        ...
        <div class="card mb-4"> 
          ...
          <!-- Card header -->
          <div class="card-header text-center"> {{ __('Pages')}} </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header"> {{ __('Recently Joined Members')}} </div>
          <div class="card-body">
